...
/**
 * Composite POJO class representing an Employee record.
 * Contains a title header and two employee records injected via Spring.
 */
public class Employee {
    ...
    public void setTitle(Details title) {
        this.title = title;
    }

    public Details getEmp1() {
        return emp1;
    }

    public void setEmp1(Details emp1) {
        this.emp1 = emp1;
    }

    public Details getEmp2() {
        return emp2;
    }

    public void setEmp2(Details emp2) {
        this.emp2 = emp2;
    }
